...
[Proxy]
[Proxy Group]
Binance = select,PROXY,interval=86400,timeout=5,select=0,url=http://www.gstatic.com/generate_204
Telegram = select,PROXY,interval=86400,timeout=5,select=0,url=http://www.gstatic.com/generate_204
